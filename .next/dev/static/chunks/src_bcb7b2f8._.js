...
const listenPedidos = (callback)=>{
    // Obtenemos la fecha de hoy como un string para la consulta
    ...
    // Creamos una consulta con una cláusula 'where' para filtrar por la fecha de hoy
    const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(pedidosCol, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])("createdAt", "==", todayString));
    // Usamos la consulta 'q' en lugar de 'pedidosCol'
...
const ListDocuments = ()=>{
    ...
    // State to hold the selected date, initialized to today
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ListDocuments.useEffect": ()=>{
            // The listener now depends on selectedDate
            ...
            }["ListDocuments.useEffect.unsubscribe"], selectedDate);
            // Cleanup the listener when the component unmounts or the date changes
            return ({
        ...
        selectedDate
    ]); // Re-run the effect when selectedDate changes
    const handleDateChange = (event)=>{
        setSelectedDate(event.target.value);
    };
    const handleDownload = (pedido)=>{
        const { id, cliente, fecha, items, total, pedidoInfo } = pedido;
        const message = `*Pedido #${id}*
*Cliente:* ${cliente}
*Fecha:* ${fecha}

*Detalles del Pedido:*
${items.map((item)=>`- ${item.nombre} (x${item.cantidad}) - $${(item.precio * item.cantidad).toFixed(2)}`).join('\n')}
...
*Total:* $${total.toFixed(2)}`;
        ...
        a.href = url;
        a.download = `pedido-${id}.txt`;
        a.click();
        URL.revokeObjectURL(url);
    };
    const handleShare = (pedido)=>{
        const { id, cliente, fecha, items, total, pedidoInfo } = pedido;
        const message = `*Pedido #${id}*
*Cliente:* ${cliente}
*Fecha:* ${fecha}
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: pedidos.length > 0 ? pedidos.map((pedido)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                            ...
                                            children: pedido.items.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onClick: ()=>handleShare(pedido),
                                                    className: "px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors focus:outline-none focus:ring-2 focus:ring-green-400",
                                                    children: "Compartir"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/documentos/page.jsx",
                                                    lineNumber: 110,
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$ui$2f$SacoUi$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "No se encontraron pedidos para la fecha seleccionada."
                                }, void 0, false, {
                                    fileName: "[project]/src/app/documentos/page.jsx",
                                    lineNumber: 123,
                                    columnNumber: 15
...
_s(ListDocuments, "88JjovGcbmhlD9dHwoF8DCEzA4o=");
_c = ListDocuments;
const __TURBOPACK__default__export__ = ListDocuments;
var _c;
...
//# sourceMappingURL=src_bcb7b2f8._.js.map